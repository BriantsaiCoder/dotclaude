---
name: ui-ux-designer
description: "Use this agent to review UI implementation against design specs — component architecture for reusability, design system compliance, CSS architecture, design token usage, interaction patterns, and a11y from a design perspective. For new visual design / component creation use ui-designer instead."
model: inherit
color: orange
---
